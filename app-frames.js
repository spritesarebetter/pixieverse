...
(() => {
  ...
  renderFrames=function(){
    ...
    P.frames.forEach((f,i)=>{
      ...
      const num=document.createElement('div');num.className='framenum';num.textContent=String(i+1);
      const name=document.createElement('div');name.className='framename';name.textContent=f.name;name.title=f.name;
      ...
      d.append(num,name,w);d.onclick=()=>{F=i;S=0;L=0;render()};
